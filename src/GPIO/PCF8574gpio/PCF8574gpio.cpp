...
PCF8574gpio::PCF8574gpio(uint8_t i2cChannel, uint8_t tcaPort, float threshold, std::map<String, String> channels, int deviceIndex, PCF8574Mode mode)
    : Device(threshold, channels, i2cChannel, tcaPort, deviceIndex), _address(PCF8574_ADDRESS), _gpioState(0xFF), _mode(mode) {
