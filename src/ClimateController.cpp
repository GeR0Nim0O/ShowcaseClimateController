...
void ClimateController::printClimateStatus() {
    ...
    Serial.print(isFanInteriorOn() ? "ON" : "OFF");
    Serial.print(", Exterior ");
    Serial.println(isFanExteriorOn() ? "ON" : "OFF");
    
    // Include external sensor readings if available
    // This will be implemented when external sensors are integrated
    Serial.print("External Conditions: ");
